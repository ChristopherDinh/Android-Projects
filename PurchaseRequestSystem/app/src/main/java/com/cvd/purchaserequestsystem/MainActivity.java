...
public class MainActivity extends AppCompatActivity implements PurchaseRequestAdapter.OnClickListener {
    public static final String EXTRA_DESCRIPTION = "imageUrl";
    public static final String EXTRA_STATUS = "creatorName";
    public static final String EXTRA_TOTAL = "likeCount";
    ...
    public void onItemCLick(int position) {
        ...
        PurchaseRequest clickedItem = prList.get(position);
        ...
        detailIntent.putExtra(EXTRA_TOTAL, clickedItem.getTotal());
